...
<body>
  <div class="flex flex-row w-screen h-screen">
    ...
    <div class="postsContainer flex-3 bg-gray-100">
      <div class="posts flex-column" <% if (selectedThread == null) {%> style="display: none" <%} %>>
        ...
        <%
          ...
          if (posts != null) {
            for(Post p : posts) { %>
              <div class="post border-red-500 border-2 w-1/2 <% if (p.getAuthor() == user) { %> justify-self-end <% } %>">
                <div class="user">
