...
%>
<body>
  <div class="flex flex-row w-screen h-screen text-lg overflow-y-hidden">
    ...
    <div class="postsContainer flex-3 bg-gray-100">
      ...
      <div class="postHeader flex flex-row px-4 py-2 bg-white items-center">
      ...
      <div class="flex flex-col justify-between">
        <div class="posts grid grid-cols-1 p-4 overflow-auto" <% if (selectedThread == null) {%> style="display: none" <%} %>>
          <%
        ...
        <div class="postEntryContainer p-8" <% if (selectedThread == null) {%> style="display: none" <%} %>>
          <div class="userEntry">
